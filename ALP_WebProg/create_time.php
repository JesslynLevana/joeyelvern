...
<body>
    ...
    <nav class="bg-slate-800 fixed top-0 w-full">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between sm:-mr-32">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4 px-5">
                            ...
                            <a href="create_time.php" class="text-orange-300 border-b-4 border-orange-300 px-3 py-5 text-sm font-medium" aria-current="page">Add Showtime</a>
        ...
        <div class="hidden sm:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pb-3 pt-3">
                ...
                <a href="create_time.php" class="bg-gray-900 text-orange-300 block rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Add Showtime</a>
            </div>
        </div>
    </nav>
    ...
    <div class="space-y-12 mt-20">
        <form action="create_time.php" method="post">
            <h2 class="lg:text-3xl text-2xl mx-8 mb-8 pt-8 font-bold leading-7 text-gray-900">CREATE SHOWTIME</h2>
            <div class="sm:col-span-2 mx-8">
                <label for="showtime" class="block text-lg font-medium leading-6 text-gray-900">Showtime</label>
                <div class="mt-2">
                    <input type="time" name="showtime" id="showtime" class="block w-full rounded-md border-0 py-1.5 pl-2 pr-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                </div>
            </div>
            <div class="mt-6 mx-5 flex items-center justify-end gap-x-6">
